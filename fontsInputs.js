...
const arrVars = (function () {
  //const varsObj = ' --main-color: #D9B88F; --text-color: #324759; --tooltip-background-color: #F27C38; --tooltip-text-color: #193C40; --secondary-color: #D99F59; --detailed-data-color: #D9CEBA; ';
